...
import MoodFruitBubbleDiaryProdScr from '../screens/MoodFruitBubbleDiaryProdScr';
...
const AppNavigator = () => {
  ...
  OneSignal.initialize('714746ce-a613-4732-aa2e-e2cf0a92ca48');
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="MoodFruitBubbleDiaryProdScr"
            component={MoodFruitBubbleDiaryProdScr}
